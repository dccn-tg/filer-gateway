...
// GetProjectsIDParams contains all the bound params for the get projects ID operation
...
func (o *GetProjectsIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
