...
func (o *GetTasksTypeIDURL) Build() (*url.URL, error) {
	...
	var _path = "/tasks/{type}/{id}"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetTasksTypeIDURL")
	}
	...
	if typeVar != "" {
		...
		return nil, errors.New("type is required on GetTasksTypeIDURL")
	}
...
func (o *GetTasksTypeIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetTasksTypeIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetTasksTypeIDURL")
	}
