...
// Validate validates this member of
func (m MemberOf) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m MemberOf) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
